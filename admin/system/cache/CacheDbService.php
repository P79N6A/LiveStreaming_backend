...
class CacheDbService extends CacheService
{
    ...
    public function __construct()
    {
        ...
        $cache_db_charset = $GLOBALS['distribution_cfg']['CACHE_DB_CHARSET'] == "" ? app_conf('DB_CHARSET') : $GLOBALS['distribution_cfg']['CACHE_DB_CHARSET'];
        $this->db = new mysql_db($cache_client . ":" . $cache_port, $cache_username, $cache_password, $cache_db, $cache_db_charset, $pconnect);
