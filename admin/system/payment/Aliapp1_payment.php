...
class Aliapp1_payment implements payment
{
...
//验证成功
    ...
    public function getPublicKeyFromX509($certificate)
    {
    ...
    public function getPrivateKeyFromX509($certificate)
    {
     ...
     * return Sign签名
     */
    public function sign($data, $rsa_private_key)
    {
        //读取私钥文件
