...
class Aliapp2_payment implements payment {
...
//		print_r($pay);exit;
	...
	{	
		...
		require_once(APP_ROOT_PATH.'system/payment/Aliapp2/alipay_notify.class.php');
		
		$payment = $GLOBALS['db']->getRow("select id,config from ".DB_PREFIX."payment where class_name='Aliapp2'");
