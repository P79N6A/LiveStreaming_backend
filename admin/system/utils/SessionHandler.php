...
class SessionHandler
{
    ...
    public function open($savePath, $sessionName)
    {
        ...
        if ($GLOBALS['distribution_cfg']['SESSION_TYPE'] == "MemcacheSASL") {
            ...
            $cache_db_charset = $GLOBALS['distribution_cfg']['SESSION_DB_CHARSET'] == "" ? app_conf('DB_CHARSET') : $GLOBALS['distribution_cfg']['CACHE_DB_CHARSET'];
            $this->db = new mysql_db($session_client . ":" . $session_port, $session_username, $session_password, $session_db, $cache_db_charset, $pconnect);
