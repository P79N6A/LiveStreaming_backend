...
class TimRestAPI extends TimRestInterface
{
     ...
     */
    public function init($sdkappid, $identifier)
    {
    ...
    //创建全员广播大群
    public function full_group_create($group_id, $aes_key)
    {
        #构造新消息
        $Introduction = '';
        if ($aes_key != '') {
    ...
    public function group_create_group($group_type, $group_name, $owner_id, $group_id = null)
    {
    ...
    public function group_add_group_member2($group_id, $mem_list, $silence)
    {
    ...
    //获取群组被禁言用户列表
    public function get_group_shutted_uin($group_id)
    {
        #构造新消息
        $msg = array(
            "GroupId" => $group_id
