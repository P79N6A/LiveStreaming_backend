    ...
    "xy_promoter"=>array(
        ...
        "groups"	=>	array(
            "promoter_one"	=>	array(
                ...
                "key"	=>	"promoter_one",
                "nodes"	=>	array(
                    array("name"=>"运营中心列表","module"=>"XyPromoterOne","action"=>"index"),
                ),
            ),
            "promoter_two"	=>	array(
                "name"	=>	"会员单位管理",
                "key"	=>	"promoter_two",
                "nodes"	=>	array(
                    array("name"=>"会员单位列表","module"=>"XyPromoterTwo","action"=>"index"),
                    array("name"=>"会员单位审核列表","module"=>"XyPromoterTwoSubmit","action"=>"index"),
                ),
            ),
            "promoter_user"	=>	array(
                "name"	=>	"推广会员管理",
                "key"	=>	"promoter_user",
                "nodes"	=>	array(
                    array("name"=>"推广会员列表","module"=>"XyPromoterUser","action"=>"index"),
                ),
            ),
