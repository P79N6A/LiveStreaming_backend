    ...
    "user" => array(
        ...
        "groups" => array(
            "user" => array(
                ...
                "key" => "user",
                "nodes" => array(
                    array("name" => "主播列表", "module" => "EduUserGeneral", "action" => "index"),
//                        array("name"=>"认证主播","module"=>"User","action"=>"index"),
            ...
            "useraudit" => array(
                ...
                "key" => "useraudit",
                "nodes" => array(
                    array("name" => "无效主播", "module" => "EduUserAudit", "action" => "index")
                )
            ),
            "usercert" => array(
                "name" => "认证管理",
                "key" => "usercert",
                "nodes" => array(
                    array("name" => "主播待审认证", "module" => "EduUserInvestor", "action" => "index"),
                    array("name" => "认证未通过", "module" => "EduUserInvestorList", "action" => "index"),
    ...
    "PlugIn" => array(
        ...
        "groups" => array(
            ...
            "user_goodsconf" => array(
                ...
                "key" => "user_goodsconf",
                "nodes" => array(
                    array("name" => "主播商品", "module" => "User_Goods", "action" => "index"),
...
//                    array("name"=>"订单列表","module"=>"EduClassOrder","action"=>"index"),
                )
            ),
            "booking" => array(
                "name" => "约课信息",
...
//                    array("name"=>"订单列表","module"=>"EduBookingOrder","action"=>"index"),
                )
            ),
            "org" => array(
                "name" => "线下课程",
            ...
            "deal" => array(
                ...
                "key" => "deal",
                "nodes" => array(
                    array("name" => "项目列表", "module" => "EduDeal", "action" => "index"),
                    array("name" => "审核列表", "module" => "EduDealSubmit", "action" => "index"),
                    array("name" => "项目回收站", "module" => "EduDealDelete", "action" => "index")
                )
            ),
            "comment" => array(
                "name" => "评论列表",
