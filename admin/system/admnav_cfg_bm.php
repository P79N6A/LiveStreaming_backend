    ...
    "score_mall" => array(
        ...
        "groups" => array(
            "score_mall" => array(
                ...
                "key" => "score_mall",
                "nodes" => array(
                    array("name" => "道具列表", "module" => "BmProp", "action" => "index")
                )
            )
    ...
    "PlugIn" => array(
        ...
        "groups" => array(
            "PlugInconf" => array(
                ...
                "key" => "PlugInconf",
                "nodes" => array(
                    array("name" => "插件配置", "module" => "PlugIn_bm", "action" => "index"),
                    array("name" => "插件购买记录", "module" => "PlugIn_bm", "action" => "order")
                )
            ),
    ...
    "bm_promoter" => array(
        ...
        "groups" => array(
            "promoter_one" => array(
                ...
                "key" => "promoter_one",
                "nodes" => array(
                    array("name" => "推广中心列表", "module" => "BmPromoterOne", "action" => "index")
                )
            ),
            "promoter_two" => array(
                "name" => "推广商管理",
                "key" => "promoter_two",
                "nodes" => array(
                    array("name" => "推广商列表", "module" => "BmPromoterTwo", "action" => "index"),
                    array("name" => "推广商审核列表", "module" => "BmPromoterTwoSubmit", "action" => "index")
                )
            ),
            "promoter_user" => array(
                "name" => "推广会员管理",
                "key" => "promoter_user",
                "nodes" => array(
                    array("name" => "推广会员列表", "module" => "BmPromoterUser", "action" => "index")
                )
            ),
            "promoter_data" => array(
                "name" => "数据分析",
                ...
                "nodes" => array(
                    /*
                    array("name"=>"游戏收益分析","module"=>"BmPromoterGame","action"=>"index"),
                    array("name"=>"礼物收益分析","module"=>"BmPromoterProp","action"=>"index"),
                    array("name"=>"秀豆礼物消费分析","module"=>"BmPromoterPropFrom","action"=>"index"),
                    array("name"=>"游戏币礼物消费分析","module"=>"BmPromoterPropFromCoin","action"=>"index"),
                    array("name"=>"游戏异常数据分析","module"=>"BmPromoterErrorGame","action"=>"index"),
                     */
                    array("name" => "会员送礼报表", "module" => "BmSendProp", "action" => "index"),
                    array("name" => "会员游戏报表", "module" => "BmUserGame", "action" => "index"),
                    array("name" => "会员充值报表", "module" => "BmRechargeList", "action" => "index"),
                    array("name" => "会员账户报表", "module" => "BmUserAccount", "action" => "index"),
                    array("name" => "会员手续费报表", "module" => "BmUserPoundage", "action" => "index"),
                    array("name" => "会员盈亏报表", "module" => "BmUserEarningst", "action" => "index"),
                    array("name" => "主播余粮报表", "module" => "BmAnchorProp", "action" => "index"),
                    array("name" => "鱼商成交报表", "module" => "BmPromoterBargain", "action" => "index"),
                    array("name" => "保证金账户查询", "module" => "BmUserMargin", "action" => "index")
                )
            ),
            "promoter_config" => array(
                "name" => "推广设置管理",
                "key" => "promoter_config",
                "nodes" => array(
                    array("name" => "推广设置", "module" => "BmConfig", "action" => "config")
                )
            ),
            "promoter_admin" => array(
                "name" => "角色管理",
                "key" => "BmAdmin",
                "nodes" => array(
                    array("name" => "权限分组列表", "module" => "BmRole", "action" => "index"),
                    /*array("name"=>"权限分组回收站","module"=>"BmRoleTrash","action"=>"index"),*/
                    array("name" => "后台员工列表", "module" => "BmAdmin", "action" => "index")
                )
            )
        ...
        "groups" => array(
            "sysconf" => array(
                ...
                "nodes" => array(
                    ...
                    array("name" => "导航设置", "module" => "Navigation", "action" => "index"),
