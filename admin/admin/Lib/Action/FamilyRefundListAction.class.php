...
class FamilyRefundListAction extends CommonAction{
...
//		}
        ...
        $sql_str = "select u.*,f.family_id from ".DB_PREFIX."user_refund as u LEFT JOIN ".DB_PREFIX."user as f on u.user_id = f.id  where f.family_id <>0 ";
