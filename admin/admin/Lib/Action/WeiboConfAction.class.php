...
class WeiboConfAction extends CommonAction{
	...
	public function mobile()
	{
		...
		$unset_code_array = array(
			...
			'has_save_video','game_commission','game_distribution1','game_distribution2','coin_exchange_rate','robot_prop_interval','robot_prop_real_interval','robot_prop_num','robot_prop_diamonds','robot_prop_total_diamonds','game_gain_for_alert'
		);
