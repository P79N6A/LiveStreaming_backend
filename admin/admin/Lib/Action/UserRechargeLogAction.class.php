...
class UserRechargeLogAction extends CommonAction
{
    ...
    public function delete()
    {
        ...
        if (isset($id)) {
            ...
            $rel_data = M('UserRechargeLog')->where($condition)->findAll();
            $list = M('UserRechargeLog')->where($condition)->delete();
