...
body {
  margin: 0;
  padding: 0;
  background: #DFDFDF url(__TMPL__Common/images/body_bg.gif) repeat-y ;
  cursor: E-resize;
}
</style>
...
<!--
var pic = new Image();
pic.src="__TMPL__Common/images/bar_open.gif";
...
<table height="100%" cellspacing="0" cellpadding="0" style="border-left:1px solid #BFBFBF;" id="tbl">
  <tr><td><a href="javascript:toggleMenu();" onfocus="this.blur();"><img src="__TMPL__Common/images/bar_close.gif" width="6" height="60" id="img" border="0" /></a></td></tr>
</table>
</body>
</html>