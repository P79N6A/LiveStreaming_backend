...
(function($) {
	var weebox = function(content, options) {
		...
		this.initBox = function() {
			...
			switch(self.options.type) {
				case 'alert':
				html =  '<div class="weedialog weealert">' +
						...
						'					<a href="javascript:void(0);" class="dialog-ok btn btn-primary btn-circle">确定</a>' +
						'					<a href="javascript:void(0);" class="dialog-cancel btn btn-default btn-circle">取消</a>' +
						'				</div>' +
						'			</td>' +
				...
				html =  '<div class="weedialog">' +
						...
						'		<div class="dialog-tc">' +
						'			<div class="dialog-tc2"><a href="javascript:;" onclick="return false" title="关闭" class="dialog-close"><i class="iconfont">&#xe623;</i></a><span class="dialog-title"></span></div>' +
						'		</div>' +
						'	</div>' +
						'	<table width="100%" border="0" cellspacing="0" cellpadding="0" >' +
						'		<tr>' +
		...
		this.initMask = function() {							
			if (self.options.modal) {
				if(self.options.type == "alert"){return;}
		...
		this.close = function() {
			$(self.dh).removeClass("dialog--open").addClass("dialog--close");
			if(self.options.type != "alert"){
				$(self.mh).removeClass("dialog-mask--open").addClass("dialog-mask--close");
			}
	...
	var weeboxs = function() {		
		...
		this.open = function(content, options) {
			...
			$(box.dh).addClass("dialog--open");
			if(options.type != "alert"){
				$(box.mh).addClass("dialog-mask--open");
			}
