    ...
    public function del_comment()
    {
        ...
        if ($info['comment_user_id'] == $user_id || $info['andmin_id'] == $user_id) {
            ...
            if ($re) {
                ...
                $comment_count = $GLOBALS['db']->getOne("select count(*) from " . DB_PREFIX . "weibo_comment where weibo_id = " . $weibo_id . "  and type = 1");
    ...
    public function publish_comment()
    {
        ...
        if ($type == 1) {
            ...
            if ($res) {
                ...
                $info = $GLOBALS['db']->getRow("select is_authentication,nick_name,head_image from " . DB_PREFIX . "user where id = $user_id");
                $root['comment']['nick_name'] = $info['nick_name'];
                ...
                if ($to_user_id) {
                    ...
                    $root['comment']['to_nick_name'] = $to_nick_name;
                }
