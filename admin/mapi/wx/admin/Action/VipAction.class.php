...
class VipAction extends CommonAction
{
    ...
    public function edit()
    {
        ...
        $vip = M('Vip')->where(array('is_effect' => 1, 'is_delete' => 0))->findAll();
    ...
    public function exchange()
    {
        ...
        //$vip = M('Vip')->findAll(array('is_effect' => 1, 'is_delete' => 0));
        $vip = M('Vip')->where(array('is_effect' => 1, 'is_delete' => 0))->findAll();
    ...
    public function addExchange()
    {
        ...
        $gift_num_time  = intval($_REQUEST['gift_num_time']);
        $gift_unit_time = intval($_REQUEST['gift_unit_time']);
        if (!$num) {
        ...
        $data  = array(
            ...
            'admin_id'       => $adm_id,
            'user_id'        => $user_id,
            'gift_num_time'  => $gift_num_time,
            'gift_unit_time' => $gift_unit_time,
            'is_effect'      => 1,
        );
        for ($i = 0; $i < $num; $i++) {
