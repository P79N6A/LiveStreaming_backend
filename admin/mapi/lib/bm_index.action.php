...
class indexModule  extends baseModule
{
 ...
 //首页
	...
	{	$root = array();
		...
		$tag_info['id']=1;
		$tag_info['name']="位置1";
		$tag_info['icon']=get_abs_img_root("./public/attachment/201612/09/14/584a4d96d8ebd.jpg");
		$tag_info['tag']=1;
		$tag_list[]=$tag_info;
		...
		$tag_info['id']=2;
		$tag_info['name']="位置2";
		$tag_info['icon']=get_abs_img_root("./public/attachment/201612/08/18/5849319a4049a.png");
		$tag_info['tag']=2;
		$tag_list[]=$tag_info;
		...
		$tag_info['id']=3;
		$tag_info['name']="位置3";
		$tag_info['icon']=get_abs_img_root("./public/images/5859e6513a3c7.png");
		$tag_info['tag']=3;
		$tag_list[]=$tag_info;
