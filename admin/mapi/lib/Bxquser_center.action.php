...
xxxx
    ...
    public function recommend()
    {
        ...
        if (!$GLOBALS['user_info']) {
            ...
            $family_recom = strim($_REQUEST['family_recom']);
            if ($family_recom) {
                $root['family_name'] = $GLOBALS['db']->getOne("select name from " . DB_PREFIX . "family where family_recom='$family_recom'");
            } else {
                $root['family_name'] = '';
            }
    ...
    public function attestation()
    {
        ...
        if (!$GLOBALS['user_info']) {
            ...
            if ($user_info) {
                ...
                $user_info['family_recom'] = strim($_REQUEST['family_recom']);
                if (defined('GAME_DISTRIBUTION') && GAME_DISTRIBUTION) {
