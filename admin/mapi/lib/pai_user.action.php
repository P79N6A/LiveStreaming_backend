...
class pai_userModule extends baseModule
{
    ...
    public function goods()
    {
        ...
        foreach ($rs['list'] as $k => $v) {
            format_pai_goods($v);
            $rs['list'][$k] = $v;
            $rs['list'][$k]['podcast_name'] = ($v['podcast_name']);
            $rs['list'][$k]['last_user_name'] = ($v['last_user_name']);
            $rs['list'][$k]['shopinfo']['shop_name'] = ($v['shopinfo']['shop_name']);
            $rs['list'][$k]['user_name'] = ($v['user_name']);
        }
    ...
    public function goods_detail()
    {
        ...
        if ($rs['status'] == 1) {
            ...
            $data['info']['podcast_name'] = ($data['info']['podcast_name']);
            $data['info']['last_user_name'] = ($data['info']['last_user_name']);
    ...
    public function dopai()
    {
        ...
        if ($rs['status'] == 1) {
            $root['data'] = $rs['data'];
            $rs['data']['info']['last_user_name'] = ($rs['data']['info']['last_user_name']);
            $rs['data']['info']['podcast_name'] = ($rs['data']['info']['podcast_name']);
            $rs['data']['pai_info']['user_name'] = ($rs['data']['pai_info']['user_name']);
            /*foreach($rs['data']['info'] as $k=>$v){
            format_pai_goods($v);
            $rs['data']['info'][$k] = $v;
            }*/
            $root['error'] = '出价成功';
