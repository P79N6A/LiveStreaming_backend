function pull_refresh($page,ajax_url,cls,vm_paging,callback){
    ...
    handleAjax.handle(ajax_url,'',"html").done(function(result){
        ...
        setTimeout(function() {
            ...
            list_ele.addClass('animated fadeIn').html(value.length > 0 ? html : '<div style="text-align:center;color:#999;font-size:0.75rem;">暂无数据</div>');

            setTimeout(function(){
                list_ele.removeClass('fadeIn');
            }, 1000);
