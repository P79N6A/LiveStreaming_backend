(function($) {   
	...
	$.fn.ui_upload = function(options){
		...
		var op = {url:null,multi:true,FilesAdded:null,FileUploaded:null,UploadComplete:null,Error:null,MaxFileSize:'2097152b',AllowImageExt:'gif,jpg,jpeg,png,bmp'}; 
		...
		var uploader = new plupload.Uploader({
			...
			filters : {
				...
				mime_types: [
					{title : "Image files", extensions : options.AllowImageExt}
				]
			}
		});
