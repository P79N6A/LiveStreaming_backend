...
$handleAjax = {
	ajax: function(options){
        ...
        return $.ajax({
            url: options.url+'&post_type=json&itype=wx',
            data: options.data,
            type: options.type,
            dataType: options.dataType,
            beforeSend:function(){
            	options.beforeSendCallBack && (typeof options.beforeSendCallBack == 'function') && options.beforeSendCallBack.call(this);
            	options.showIndicator && $.showIndicator();
            },
            complete: function(){
            	options.completeCallBack && (typeof options.completeCallBack == 'function') && options.completeCallBack.call(this);
            	options.showIndicator && $.hideIndicator();
            }
        });
    },
  	handle: function(options){
  		var op = { url:'', data:null, type:'POST', dataType:'json', isTip:true, showIndicator:true, beforeSendCallBack:null, completeCallBack:null };
		options = $.extend({},op, options);
		(options.dataType == 'html') && (options.data.post_type = null);
